        ...
        if (state is HomeDashState) {
          return Scaffold(
            ...
            appBar: PreferredSize(
              ...
              child: _HomeAppBar(userName: state.userName),
            ),
        ...
        children: [
          ...
          Expanded(
            child: Column(
              ...
              children: [
                Text(AppStrings.welcomeBack2, style: AppTextStyles.homeWelcome),
                Text(userName, style: AppTextStyles.homeUserName),
              ],
            ),
          ),
          ...
          Row(
            ...
            children: [
              QuickActionButton(
                ...
                label: AppStrings.donateBlood,
                onTap: () =>
                    Navigator.pushNamed(context, AppRoutes.donateBlood),
              ),
              QuickActionButton(
                icon: Icons.bloodtype,
                label: AppStrings.requestBlood,
